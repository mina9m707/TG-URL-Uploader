...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds. \nJoin : @TGBotsZ \nUploaded in {} seconds. \n Size :{}".format(humanbytes(current))
...
<b>馃憠 Create own Clone Bot :</b> 馃憠 <a href="https://youtu.be">Diploy</a>
...
漏 """
    ...
    EXTRACT_ZIP_INTRO_THREE = "Analyzing received file. 鈿狅笍 This might take some time. Please be patient. "
